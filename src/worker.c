...
static void *worker_thread(void *data)
{
	...
	(void)snprintf(name, sizeof(name), "so/wrk: %d", w->id);
 ...
 *   This function does not return a value.
 */
static void worker_stop(struct ev_loop *loop, const char *msg)
{
...
int worker_run(void)
{
	...
	prg.workers = MEM_CALLOC(cfg.num_workers, sizeof(*(prg.workers)));
